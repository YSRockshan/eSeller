...
{
    public partial class Biz_BudgetSummery : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            public void buttonPrint_Click(object sender, EventArgs e)
            {
                if (gridViewSalesBudgetSummary.HeaderRow.Cells.Count > 0)
                {
                  ...
                  "window.open( '../ReprotViewerForm.aspx?mainform=BudgetSummeryForm&busUnit=" + Session[WebView.Home.Global.BizLoginBranchName] +
