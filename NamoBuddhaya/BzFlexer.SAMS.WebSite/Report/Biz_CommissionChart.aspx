<%@ Page Title="" Language="C#" MasterPageFile="~/Report/Report.master" AutoEventWireup="true" CodeBehind="Biz_CommissionChart.aspx.cs" Inherits="BzFlexer.SAMS.WebSite.ReportCenter.Biz_CommissionChart" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <li>
                ...
                <div>--%>
                    ...
                    <asp:TextBox ID="textBoxDateTo" runat="server" CssClass="textbox_size2" Width="18%"></asp:TextBox><cc1:CalendarExtender
                        runat="server" ID="calendarExtenderDateTo" TargetControlID="textBoxDateTo" PopupButtonID="textBoxDateTo">
                    </cc1:CalendarExtender>
                </div>
            </li>
            <li>
    ...
    <fieldset>
        <ul class="form">
            ...
            <li>
                <div class="gridfield">
                    <asp:Chart Height="360px" Width="660px" ID="CommissionChart" runat="server">
                        <Series>
                        ...
                        <ChartAreas>
                            <asp:ChartArea Name="DefaultChartArea" BorderColor="DarkRed" BackColor="White">
                                <%--<Area3DStyle Enable3D="true" LightStyle="Simplistic" />
                                 <%--<AxisY Title="Att.Percentage(%)" TitleAlignment="Near" TitleForeColor="ActiveCaptionText">
                                        <MajorGrid Enabled="true" />
                                        <LabelStyle ForeColor="Black" />
                                    </AxisY>
                                    <AxisX Title="Months(2012)" TitleAlignment="Center" TitleForeColor="ActiveCaptionText">
