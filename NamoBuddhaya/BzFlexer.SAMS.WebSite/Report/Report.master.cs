    ...
    public partial class Report : System.Web.UI.MasterPage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Session[WebView.Home.Global.BizLoginUserStakeholderId] != null)
            {
                ...
                if (exsist == 0 && frmName != "ReportCenterHomeForm")
                {
                    Response.Redirect("~/Report/ReportCenterHomeForm.aspx");
                }
                else
                    LoadNavigationMenu();
            }
