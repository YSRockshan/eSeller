<%@ Page Title="" Language="C#" MasterPageFile="~/Report/Report.master" AutoEventWireup="true" CodeBehind="Biz_BudgetSummery.aspx.cs" Inherits="BzFlexer.SAMS.WebSite.ReportCenter.Biz_BudgetSummery" %>
                ...
                <div class="gridfield">
                    <asp:GridView ID="gridViewSalesBudgetSummary" runat="server" Caption="Sales Budget Summary"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="SalesBudgetDetailId" HeaderText="SalesBudgetDetaild" />
                            ...
                            <asp:TemplateField HeaderText="Description">
                                <ItemTemplate>
                                    <asp:Label ID="LabelDescription" runat="server" Text='<%# Bind("Product.Description") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                           <asp:BoundField DataField="Type" HeaderText="Type" />
                            ...
                            <asp:TemplateField HeaderText="Sales Budget">
                                <ItemTemplate>
                                    <asp:Label ID="LabelSalesBudget" runat="server" Text='<%# Bind("SalesBudget.Description") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                        <EmptyDataTemplate>
