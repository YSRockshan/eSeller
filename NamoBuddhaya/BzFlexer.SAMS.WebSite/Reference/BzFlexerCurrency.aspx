<%@ Page Title="" Language="C#" MasterPageFile="~/Reference/ReferenceHome.master" AutoEventWireup="true" CodeBehind="BzFlexerCurrency.aspx.cs" Inherits="BzFlexer.SAMS.WebView.Reference.BzFlexerCurrency" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="formtitle">
        <asp:Label ID="labeFormTitle" runat="server" Text="Currency"></asp:Label>
    </div>
    <fieldset>
        <ul class="form">
            <li>
                <div class="gridfield">
                    <asp:GridView ID="gridViewCurrency" runat="server" CssClass="ColStyle" Caption="Currency"
                        EmptyDataText="No Data to Display" AutoGenerateColumns="false" Width="99.6%" Visible="true"
                        OnRowCreated="gridViewCurrency_RowCreated" OnSelectedIndexChanged="gridViewCurrency_SelectedIndexChanged"
                        OnPageIndexChanging="gridViewCurrency_PageIndexChanging">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="Id" HeaderText="CurrencyId" />
                                ...
                                <asp:UpdatePanel ID="updatePanelAdd" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <ul class="form">
                                            <li>
                                                <div class="formfield">
                                                    <asp:Label ID="labelCurrencyCode" runat="server" Text="Currency Code" CssClass="legendlabel_size2"></asp:Label>
                                                    <asp:TextBox ID="textBoxCurrencyCode" runat="server" MaxLength="3" Width="10%" CssClass="textbox_size2Upper"></asp:TextBox>
                                ...
                                <asp:UpdatePanel ID="updatePanelEdit" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <ul class="form">
                                            <li>
                                                <div class="formfield">
                                                    <asp:Label ID="labelCurrencyCode2" runat="server" Text="Currency Code" CssClass="legendlabel_size2" ></asp:Label>
                                                    <asp:TextBox ID="textBoxCurrencyCode2" runat="server" MaxLength="3" Width="10%" CssClass="textbox_size2Upper" Enabled="false"></asp:TextBox>
                                                    <font color="#FF0000">*</font>
                                                </div>
                                            </li>
                                            <li>
