<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm.aspx.cs" Inherits="BzFlexer.SAMS.WebView.eCommerce.web.WebForm" %>
  ...
  <div class="wrap"> 
	  <div class="header-top">
		  <div class="header-left">
			 <div class="logo">
				<a href="index.html"><img src="../BoostUnit/eCommerce/images/logo.png" /></a>
			 </div>
			 <div class="cssmenu">
				<ul>
					 ...
					 <li class="has-sub"><a href="work.aspx"><span>My Work</span></a></li>
		  ...
		  <div class="header-right">
			<div id="loginContainer">
				 <span>Sign In To BizFlexer</span><a id="loginButton" ><img src="images/plus.png"  alt="" /></a>   
				     <div id="loginBox" >  <%-- style="display: block;"--%>
                          <form id="loginForm" runat="server">             
				      
				             <div>
						    	<span><label>E-Mail</label></span>
                                 <span><asp:TextBox ID="textBoxEmail" runat="server" ></asp:TextBox></span>
						    	<%--<span><input id="textBoxEmail"  type="text" class="textbox"/></span>--%>
						    </div>
                               <div>
						    	<span><label>Password</label></span>
                                      <span>   <asp:TextBox ID="textBoxPassword" runat="server" TextMode="Password" ></asp:TextBox></span>
	   ...
	   <div class="header-bottom">
	   	   <ul class="follow_icon">
				 <li><a href="#" style="opacity: 1;"><img src="../BoostUnit/eCommerce/images/fb.png" alt=""/></a></li>
				 <li><a href="#" style="opacity: 1;"><img src="../BoostUnit/eCommerce/images/tw.png"  alt=""/></a></li>
				 <li><a href="#" style="opacity: 1;"><img src="../BoostUnit/eCommerce/images/rss.png" alt=""/></a></li>
		   </ul>
				  ...
				  <div class="resp-tabs-container">
					  <div class="tab-1">
						<div class="tab-content">
							...
							<div class="rsidebar span_1_of_3">
                                <img src="../BoostUnit/eCommerce/images/footer-banner.png"  alt=""/> 
							</div>
						   	<div class="clear"></div> 
						</div>
	    			   </div>
    ...
    <%--start footer--%>
     <div class="footer">
  	   <div class="wrap">
  			<div class="bottom-content">
	  		    <div class="col_1_of_footer span_1_of_footer">
	  		      <div class="footer-logo">
                        <a href="index.aspx"><img src="../BoostUnit/eCommerce/images/logo.png" alt=""/></a>
			 	  </div>
	       ...
	       <div class="copy">
		      <p class="copy">© 2017 Designed by <a href="http://BizFlexer.com" target="_blank">BizFlexer</a> </p>
	       </div>
  	   </div>
  </div>
    <%--end footer--%>
