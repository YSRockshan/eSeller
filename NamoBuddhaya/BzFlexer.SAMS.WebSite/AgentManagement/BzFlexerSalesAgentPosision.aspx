<%@ Page Title="" Language="C#" MasterPageFile="~/AgentManagement/AgentManagementHome.master" AutoEventWireup="true" CodeBehind="BzFlexerSalesAgentPosision.aspx.cs" Inherits="BzFlexer.SAMS.WebView.AgentManagement.BzFlexerSalesAgentPosision" %>
<%@ Register Src="~/BoostUnit/ValidationText.ascx" TagName="FlashText" TagPrefix="Biz" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>

<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="formtitle">
        <asp:Label ID="labelFormTitle" runat="server" Text="Sales Agent Positions"></asp:Label>
    </div>
    <fieldset>
        <ul class="form">
            <li>
                <div class="gridfield">
                    <asp:GridView ID="gridViewSalesRepsPosition" runat="server" Caption="Sales Agent Positions"
                        CssClass="ColStyle" EmptyDataText="No data to display" AllowPaging="True" PageSize="10"
                        Width="99.6%" AutoGenerateColumns="false" OnRowCreated="gridViewSalesRepsPosition_RowCreated"
                        OnPageIndexChanging="gridViewSalesRepsPosition_PageIndexChanging" OnSelectedIndexChanged="gridViewSalesRepsPosition_SelectedIndexChanged">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="Id" HeaderText="SalesRepPositionId" />
                        ...
                        <cc1:AccordionPane ID="accordionPaneAdd" runat="server" HeaderCssClass="accordionHeader">
                            ...
                            <Content>
                                <ul class="form">
                                    <li>
                                        <div class="formlable">
                                            <asp:Label ID="labelSalesRepPositionCodeAdd" runat="server" Text="Branch Code" CssClass="legendlabel_size2"></asp:Label>
                                            <asp:TextBox ID="textBoxSalesRepPositionCodeAdd" runat="server" Width="100px" Enabled="true"
                                    ...
                                    <li>
                                        <div class="formlable">
                                            <asp:Label ID="labelSalesRepPositionDescriptionAdd" runat="server" Text="Description"
                                                CssClass="legendlabel_size2"></asp:Label>
                                            <asp:TextBox ID="textBoxSalesRepPositionDescriptionAdd" runat="server" Width="300px"
                        ...
                        <cc1:AccordionPane ID="accordionPaneEdit" runat="server" HeaderCssClass="accordionHeader">
                            ...
                            <Content>
                                <ul class="form">
                                    <li>
                                        <div class="formlable">
                                            <asp:Label ID="labelSalesRepPositionModify" runat="server" Text="Branch Code" CssClass="legendlabel_size2"></asp:Label>
                                            <asp:TextBox ID="textBoxSalesRepPositionModify" runat="server" Width="100px" Enabled="false"
                                    ...
                                    <li>
                                        <div class="formlable">
                                            <asp:Label ID="labelSalesRepPositionDescriptionModify" runat="server"
                                                Text="Description" CssClass="legendlabel_size2"></asp:Label>
                                            <asp:TextBox ID="textBoxSalesRepPositionDescriptionModify" runat="server" Width="300px"
                                    ...
                                    <li>
                                        <div class="buttonlist2">
                                            <asp:Button ID="buttonModify" runat="server" Text="Save" CssClass="button_normal" TabIndex="7" OnClick="buttonModify_Click" />
