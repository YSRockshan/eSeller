<%@ Page Title="" Language="C#" MasterPageFile="~/AgentManagement/AgentManagementHome.master" AutoEventWireup="true" CodeBehind="BzFlexerBudgetPeriods.aspx.cs" Inherits="BzFlexer.SAMS.WebView.AgentManagement.BzFlexerBudgetPeriods" %>
<%@ Register Src="~/BoostUnit/ValidationText.ascx" TagName="FlashText" TagPrefix="Biz" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>

<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="formtitle">
        <asp:Label ID="labelTitle" runat="server" Text="Budget Periods"></asp:Label>
    </div>
    <fieldset>
        <ul class="form">
            <li>
                <div class="gridfield">
                    <asp:GridView ID="gridViewForecastPeriod" runat="server" AllowPaging="true" AutoGenerateColumns="false"
                        Caption="Budget Periods" CssClass="ColStyle" EmptyDataText="No Data to Display"
