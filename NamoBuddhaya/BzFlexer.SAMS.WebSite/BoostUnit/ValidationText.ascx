<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ValidationText.ascx.cs" Inherits="BzFlexer.SAMS.WebView.BoostUnit.ValidationText" %>

<script language="javascript" type="text/javascript">    

        //handle the object opacity  (opacity range 0.0 to 1.0)       
...
<%--    <asp:Label ID="lblMessage" runat="server" style="display:none;background-color:#3B5998; color:#FFFFFF ;font-family:Arial;font-size:small"/>--%>    
    <asp:Label ID="lblMessage" runat="server" style="display:none;"/>     
    <asp:Button ID="buttonFalseFocus" runat="server" Width="1px" Height="1px" BackColor="#ECF3FB" BorderStyle="None" BorderColor="#ECF3FB" BorderWidth="0" />
