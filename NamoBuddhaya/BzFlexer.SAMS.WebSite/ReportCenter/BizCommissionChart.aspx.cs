...
{
    public partial class BizCommissionChart : System.Web.UI.Page
    {
        ...
        protected override void OnDataBinding(EventArgs e)
        {
            ...
            CommissionChart.Titles.Add("Commission Summary");
        ...
        public void GetDataTogridViewSalesCommissionSummary()
        {
            ...
            branchSelesAgents = new Biz_BranchSalesAgentService().ReadAllBranchSelesAgents();
            ...
            if (dropDownListBranch.SelectedIndex > 0)
            {
                ...
                branchSelesAgents = (from branchSelesRep in branchSelesAgents
                                   where branchSelesRep.IdBranch == Convert.ToInt16(dropDownListBranch.SelectedValue)
            ...
            List<long> stkIdList = (from id in branchSelesAgents select id.IdStakeholder).ToList();
